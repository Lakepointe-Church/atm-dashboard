...
export function StatCard({ label, value, sub, color, loading, compact }: {
  ...
  const d = compact
    ? { padding: '20px 22px 18px', labelMb: '10px', value: '26px', skel: '22px', sub: '11px', subMt: '8px' }
    : { padding: '24px 24px 22px', labelMb: '12px', value: '30px', skel: '25px', sub: '12px', subMt: '10px' }
  return (
    <div
